...
export class DddStepsListItem extends DDDSuper(LitElement) {
    ...
    return [
      ...
      css`
        :host {
          ...
          border-left: 4px solid var(--circle-color, var(--ddd-primary-5));
        ...
        .step {
          width: 32px;
          height: 32px;
          background-color: var(--circle-color, var(--ddd-primary-5));
  ...
  render() {
    return html`
      <div class="header">
        <div class="step" style="--circle-color: var(--ddd-primary-${this.dddPrimary});">
          ${this.step}
        </div>
        ${this.header}
      </div>
